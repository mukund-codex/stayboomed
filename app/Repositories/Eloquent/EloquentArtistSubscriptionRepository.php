...
use App\Exports\{ArtistSubscriptionExport};
use App\Imports\ArtistSubscriptionImport;
use Illuminate\Support\Collection;

class EloquentArtistSubscriptionRepository implements ArtistSubscriptionRepository
{
...
/**
    ...
    */
    ...
    {
        return ArtistSubscription::find($id);
    }
    ...
    */
    ...
    {
        return ArtistSubscription::where($data)->first();
    }
    ...
    */
    ...
    {
        return ArtistSubscription::where($key, $value)->first();
    }
    ...
    */
    ...
    {   
        ...
        $c_data['subscription_id'] = $subscription_id;

        $appliedSubscription = ArtistSubscription::create($c_data);
    ...
    */
    public function filtered($filter, $operator)
    {
        ...
        return ArtistSubscription::select('artist_subscription.*')
        ...
        ->whereNull('artist_subscription.deleted_at');
    }
