...
/**
    ...
    */
    ...
    {      
        ...
        $c_data['age'] = $age;
        $c_data['city_leaving'] = $city_leaving;
        $c_data['physical_attribute'] = $physical_attribute;
        $c_data['experience'] = $experience;
        $c_data['education'] = $education;
        $c_data['profession_id'] = $profession_id;
        $c_data['budget'] = $budget;
        $c_data['budget_time'] = $budget_time;
