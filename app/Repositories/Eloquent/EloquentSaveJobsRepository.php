...
use App\Exports\{SaveJobsExport};
use App\Imports\SaveJobsImport;
use Illuminate\Support\Collection;

class EloquentSaveJobsRepository implements SaveJobsRepository
{
...
/**
    ...
    */
    ...
    {
        return SaveJobs::where($data)->first();
    }
    ...
    */
    ...
    {
        return SaveJobs::where($key, $value)->first();
    }
    ...
    */
    ...
    {   
        ...
        $saveJobs = SaveJobs::create($c_data);
    ...
    */
    public function update($id, array $data)
    {
        ...
        $artistDetails = SaveJobs::where('id', $id)->update($d_data);  
    ...
    */
    ...
    {
        $saveDetails = $this->find($id);

        if(!$saveDetails instanceof SaveJobs) {
            return false;
        }
        
        return $saveDetails->delete();
    }
